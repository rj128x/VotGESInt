...
namespace VotGES.Piramida.Report
{
	public class ReportLinesRecords
	{
		...
		public static RecordTypeCalc P_KL_Shluz1=new RecordTypeCalc("P_KL_Shluz1", "КЛ 6кВ Шлюз-1", null);
		public static RecordTypeCalc P_KL_Shluz2=new RecordTypeCalc("P_KL_Shluz2", "КЛ 6кВ Шлюз-2", null);
		public static RecordTypeCalc P_KL_Filtr1=new RecordTypeCalc("P_KL_Filtr1", "КЛ 6кВ Фильтровальная-1", null);
		public static RecordTypeCalc P_KL_Filtr2=new RecordTypeCalc("P_KL_Filtr2", "КЛ 6кВ Фильтровальная-2", null);
