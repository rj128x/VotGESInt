...
namespace VotGES.Piramida
{
	public static class PiramidaRecords
	{
		...
		public static PiramidaRecord MB_GA1_Rashod=new PiramidaRecord(2, 3, 208, "Г1 Расход");
		...
		public static PiramidaRecord MB_GA2_Rashod=new PiramidaRecord(2, 3, 258, "Г2 Расход");
		...
		public static PiramidaRecord MB_GA3_Rashod=new PiramidaRecord(2, 3, 308, "Г3 Расход");
		...
		public static PiramidaRecord MB_GA4_Rashod=new PiramidaRecord(2, 3, 358, "Г4 Расход");
		...
		public static PiramidaRecord MB_GA5_Rashod=new PiramidaRecord(2, 3, 408, "Г5 Расход");
		...
		public static PiramidaRecord MB_GA6_Rashod=new PiramidaRecord(2, 3, 458, "Г6 Расход");
		...
		public static PiramidaRecord MB_GA7_Rashod=new PiramidaRecord(2, 3, 508, "Г7 Расход");
		...
		public static PiramidaRecord MB_GA8_Rashod=new PiramidaRecord(2, 3, 558, "Г8 Расход");
		...
		public static PiramidaRecord MB_GA9_Rashod=new PiramidaRecord(2, 3, 608, "Г9 Расход");
		...
		public static PiramidaRecord MB_GA10_Rashod=new PiramidaRecord(2, 3, 658, "Г10 Расход");
